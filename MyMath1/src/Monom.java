 ...
 * see:hg https://en.wikipedia.org/wiki/Monomial 
...
public class Monom implements function{
	...
	/**
	 * add o1 to this Monom
	 * @param o1 
	 * @throws - if they don't have the same power 
	 */
	public void add(Monom o1) {
		if(this._power!=o1._power){throw new RuntimeException("this function cant add this monon because they are not from the same type");}
		else
			this.set_coefficient(this.get_coefficient()+o1.get_coefficient());
	}
	
	/**
	 * subtract o1 from this monom
	 * @param Monom o1 
	 * @throws if they don't have the same power 
	 */
	public void sub(Monom o1) {
		if(this._power!=o1._power){throw new RuntimeException("this function cant add this monon because they are not from the same type");}
		else
			this.set_coefficient(this.get_coefficient()-o1.get_coefficient());
	}
	...
	/**
	 * 
	 * this function multiply this monom whit o1, 
	 * @param Monom o1
	 */
	public void multiply(Monom o1) {
		this._coefficient=this._coefficient*o1._coefficient;
		this._power=this._power+o1._power;
	}
	/**
	 * 
	 * this function check if this monom is equals to o1 
	 *only if the coefficient and the power is equals return true
	 *@param o1
	 *@return boolean
	 */
	public boolean equals(Monom o1) {
		if((this.get_coefficient()==o1.get_coefficient())&&(this.get_power()==o1.get_power()))
			return true;
		return false;
	}
